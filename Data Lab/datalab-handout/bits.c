 ...
 *   Rating: 1
 */
// 确认最大int数并返回“-1“： Tmax + ～Tmax（按位取反为”1111...1）“ ，然后值求非。
//需要注意排除x为“1111...1”的情况，因为x+(x + 1)也为“1111...1”
int isTmax(int x) {
  int Tmin = x + 1;
  x = x + Tmin;
  x = ~x;
  //只有x是“0x0111...1,则!（x + 1) = 0, x = 0 + !(x+1) = 0x00...0
  //若x是“0x1111...1”，则!(x + 1) = 1, x = 0 + !(x+1) =  1
  Tmin = !Tmin;
  x += Tmin;
  return !x;
}
 ...
 *   Rating: 2
 */
//判断一个数所有的奇数位是否为1，利用mask与x做与运算，将奇数位的1保留。然后与mask做异或运算判断是否奇数位全是1。
int allOddBits(int x) {
  //step1: remain zero bit step2: xor with mask to remove other bits.
  int mask = 0xAA + (0xAA << 8);
  mask = mask + (mask << 16);
  //1010 1010 1010 1010 1010 1010 1010 1010
  //0101 1111 0101 0101 1111 1111 1111 1111--- &（odd）
  //-》0000 1010 0000 0000 1010 1010 1010 1010
  //   1010 1010 1010 1010 1010 1010 1010 1010-- ^
  // 1010 0000 1010 1010 0000 0000 0000 0000
